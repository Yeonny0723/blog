---
title: "가슴 끓었던 Hashed Meetup"
date: "2026-01-30"
tags: ["밋업", "블록체인", "스타트업"]
description: "기술과 비즈니스"
---

## 👋 세상이 바뀌고 있다는 걸 체감했습니다

오전 반차를 쓰고 [Hashed Vibe Labs Seoul](https://luma.com/x4yml1a1)에 다녀왔고, 오랜만에 느끼는 가슴 뜀과 여운에 다시 키보드를 잡았습니다 ㅎㅎ

행사장에는 타 개발 커뮤니티 나잇에서 봤던 분들, 같은 사이드 프로젝트 기획자분 등 눈빛 초롱초롱한 사람들로 가득했습니다.

개발 컨퍼런스는 자주 가봤지만, 처음으로 이런 사업/비즈니스/블록체인 밋업을 다녀왔는데요, 기술적인 무게감 대신 분위기는 유쾌했고, 사무실에 앉아 열심히 개발하던 일상과는 대비되는 열정 넘치는 세상을 보고 왔어요.
...
사업적인 컨퍼런스에서는...**기술에 몰입한 개발자가 보지 못하는 세상의 흐름**을 다뤘습니다. 크게 기억에 남는 인사이트를 정리해보았습니다.
...
#### 앞으로 개인 경쟁력 — Domain → Product 변환 능력
...
- 개발자들은 자신이 병목이 되지 않기 위해 실험을 하고 있습니다
...
- 결과의 책임은 인간이 지고, 그러기 위해선 이해하지 못하는게 쌓이지 않도록 경계해야 합니다.

하지만 스타트업씬이라면?

- 초반에 속도는 빠르지만, 기능 추가에 따라 더뎌지는 구조와 초반에는 느리지만, 기능 추가가 빨라지는 구조에서 우리는 평생 고민할 것이라 생각합니다.
- 책임 소재 파악과 + 모르는게 쌓여감으로써 읽은 것보다 빠른 스피드로 정부과 규제로부터의 해자를 만들 수 있는 이득이 더 큰 것 같아요.

비즈니스와 세상의 흐름을 이해하는 플레이어로 남아야겠다는 생각으로 하루를 마무리하며, 밋업 준비해주신 관계자분들, 좋은 인사이트 공유해주신 연사자분들 감사드립니다.

저는 기존 언어교환의 지루한 스몰톡을 넘어서 더 몰입감 있고, 실제로 효과적인 연습을 할 수 있게 돕는 언어 교환 서비스 BeAS를 만들고 있어요.
